...
extern int  CSLen(const char *sptr);
extern void SOut(const char *sptr, int tx, int ty, BYTE fcol, int bcol=-1, BYTE form=0);
extern void SOutS(const char *sptr, int tx, int ty, BYTE fcol, BYTE bcol, BYTE form=0);
...
extern void TOutSt(const char *tptr, int *mwdt, int *mhgt);
extern void FTOut(const char *tptr, int tx, int ty, int wdt, int maxhgt, int startl, BYTE fcol, int bcol, BYTE form);
extern void FTOutSt(const char *tptr, int wdt, int startl, int *loutp);
extern void FTOutGetHL(const char *tptr, int wdt, int maxhgt, int startl, int ax, int ay, char *gethl);
